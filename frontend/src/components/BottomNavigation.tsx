    ...
    const tabs = [
        {
            name: 'Home',
            label: 'Home',
            icon: (color: string) => <Ionicons name={activeTab === 'Home' ? "home" : "home-outline"} size={activeTab === 'Home' ? 24 : 26} color={color} />,
            onPress: () => navigation.navigate('Dashboard'),
        },
        {
            name: 'Explore',
            label: 'Explore',
            icon: (color: string) => <Feather name="compass" size={26} color={color} />,
            onPress: () => navigation.navigate('Explore'),
        },
        {
            name: 'Chat',
            label: 'Chat',
            icon: (color: string) => <Ionicons name={activeTab === 'Chat' ? "chatbubble" : "chatbubble-outline"} size={activeTab === 'Chat' ? 24 : 26} color={color} />,
            onPress: () => navigation.navigate('ChatList'),
        },
        {
            name: 'Profile',
            label: 'Profile',
            icon: (color: string) => <Ionicons name={activeTab === 'Profile' ? "person" : "person-outline"} size={activeTab === 'Profile' ? 24 : 26} color={color} />,
