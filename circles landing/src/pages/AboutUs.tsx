        ...
        <div className="about-page">
            ...
            <section className="about-hero">
                <div className="container">
                    <h1>About <br /> <span className="text-gradient">Circles Health App</span></h1>
                    <p className="hero-lead">
                        Our mission is to help more people access meaningful, everyday support through reflection, connection, and shared care.
                    </p>
                </div>
            </section>
