            ...
            <div className="container">
                <div className="showcase-content">
                    <div className="text-side">
                        ...
                        <p>
                            Built with empathy and simplicity at its heart, Circles Health App by Empylo offers a calm, guided experience centered on what truly matters: connection and wellbeing.
                        </p>
                    ...
                    <div className="image-side">
                        <div className="phone-mockup glow-effect">
                            <img src={appScreen1} alt="Circles Health App screen" />
                        </div>
                    </div>
                </div>
            </div>
