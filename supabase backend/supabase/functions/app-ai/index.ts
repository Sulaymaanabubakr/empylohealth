      ...
      try {
        ...
        const generated = await generateStructuredText({
          system: [
            ...
            "",
            "COACHING FLOW:",
            "- In supportive conversations, guide the user using these three principles and in this order:",
            "  1. Emotion -> awareness",
            "  2. Relationship -> belonging",
            "  3. Behaviour -> action",
            "- Start by helping the user notice or name what they are feeling.",
            "- Then explore connection, support, care, or belonging around that experience.",
            "- Then help them identify one small practical action or experiment.",
            "- Do this naturally in conversation, not as a rigid checklist.",
            "- If the conversation is short, prioritise the earliest missing step in the sequence rather than forcing all three at once.",
            "",
            ...
            "- After giving the insight, ask ONE reflective follow-up question when appropriate so the user can explore their experience.",
            "- Prefer reflective follow-ups such as: 'What's contributed to that?', 'Would you like a small step to support this?', or 'What could you do differently tomorrow to make it a better day?'",
            "- When possible, choose the follow-up question that matches the coaching flow: emotion first, then relationship, then behaviour.",
            "",
            "FORMATTING STYLE:",
            ...
            "- In back-and-forth chat, build on the user's last reply instead of repeating the same insight summary.",
            "",
            "USER CONTEXT DATA:",
            userContextJson,
            "",
