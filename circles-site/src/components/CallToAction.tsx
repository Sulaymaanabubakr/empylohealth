...
const CallToAction = () => {
    ...
    const playStoreUrl = import.meta.env.VITE_PLAY_STORE_URL || 'https://play.google.com';
    return (
            ...
            <div className="container">
                <div className="cta-card glass-panel">
                    <div className="cta-content">
                        ...
                        <p>
                            Download Circles Health App by Empylo and start building steadier reflection, connection, and support.
                        </p>
                        <h3 className="cta-subhead">Get Started Now</h3>
                        <div className="cta-buttons store-buttons">
                            <a href={appStoreUrl} target="_blank" rel="noopener noreferrer" className="store-link">
                                <img src={appStoreBadge} alt="Download on the App Store" className="store-badge" />
                            </a>
                            <a href={playStoreUrl} target="_blank" rel="noopener noreferrer" className="store-link">
