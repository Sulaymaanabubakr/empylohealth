        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">Manage reported content and user suspensions.</p>
                </div>
                ...
                <div className="relative w-full md:w-64">
                    ...
                    <input
                        ...
                        className="w-full pl-9 pr-4 py-2 bg-white border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-red-100 focus:border-red-400 outline-none transition-all"
                    />
                </div>
            </div>
            ...
            <div className="flex p-1 bg-gray-100 rounded-xl w-fit">
                <button
                    ...
                    className={clsx("px-4 py-1.5 text-sm font-medium rounded-lg transition-all", activeTab === 'users' ? "bg-white text-gray-900 shadow-sm" : "text-gray-500 hover:text-gray-700")}
                >
                    Users
                </button>
                <button
                    onClick={() => setActiveTab('circles')}
                    className={clsx("px-4 py-1.5 text-sm font-medium rounded-lg transition-all", activeTab === 'circles' ? "bg-white text-gray-900 shadow-sm" : "text-gray-500 hover:text-gray-700")}
                >
                    Circles
                </button>
            </div>
