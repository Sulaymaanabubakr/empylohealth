...
interface ContentItem {
    ...
    access?: {
        ...
        plans?: Array<'free' | 'pro' | 'premium' | 'enterprise'>;
...
interface EditFormState {
    ...
    accessPlans: Array<'free' | 'pro' | 'premium' | 'enterprise'>;
    shareRequiresPremium: boolean;
}
...
const getAccessPlans = (item?: ContentItem): Array<'free' | 'pro' | 'premium' | 'enterprise'> => {
    const plans = Array.isArray(item?.access?.plans)
        ? item!.access!.plans!
            ...
            .filter((plan): plan is 'free' | 'pro' | 'premium' | 'enterprise' => (
                plan === 'free' || plan === 'pro' || plan === 'premium' || plan === 'enterprise'
            ))
        : [];
