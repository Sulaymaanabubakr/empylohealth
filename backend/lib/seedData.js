...
exports.seedAffirmationData = exports.seedAffirmationImages = exports.seedResourceData = exports.seedChallengeData = void 0;
exports.seedChallengeData = [
    {
...
exports.seedAffirmationData = [
    ...
    // New affirmations (45 more)
    { content: 'I embrace each day as a new beginning.', tags: ['Courage'], status: 'active' },
    { content: 'I am becoming the best version of myself.', tags: ['Growth'], status: 'active' },
    { content: 'My potential is limitless.', tags: ['Career'], status: 'active' },
    { content: 'I attract positivity and abundance.', tags: ['Gratitude'], status: 'active' },
    { content: 'I am grateful for this moment.', tags: ['Gratitude'], status: 'active' },
    { content: 'I release what no longer serves me.', tags: ['Growth'], status: 'active' },
    { content: 'I am worthy of success and happiness.', tags: ['Love'], status: 'active' },
    { content: 'I trust the timing of my life.', tags: ['Courage'], status: 'active' },
    { content: 'I am at peace with my past.', tags: ['Growth'], status: 'active' },
    { content: 'My body is healthy and strong.', tags: ['Health'], status: 'active' },
    { content: 'I choose joy in every moment.', tags: ['Love'], status: 'active' },
    { content: 'I am a magnet for miracles.', tags: ['Gratitude'], status: 'active' },
    { content: 'I honor my own boundaries.', tags: ['Relationships'], status: 'active' },
    { content: 'I am confident in my decisions.', tags: ['Courage'], status: 'active' },
    { content: 'I attract meaningful connections.', tags: ['Relationships'], status: 'active' },
    { content: 'My mind is calm and clear.', tags: ['Health'], status: 'active' },
    { content: 'I welcome change with open arms.', tags: ['Growth'], status: 'active' },
    { content: 'I am creating the life I desire.', tags: ['Career'], status: 'active' },
    { content: 'I celebrate my small victories.', tags: ['Hard work'], status: 'active' },
    { content: 'I radiate warmth and kindness.', tags: ['Love'], status: 'active' },
    { content: 'I am exactly where I need to be.', tags: ['Gratitude'], status: 'active' },
    { content: 'My challenges help me grow stronger.', tags: ['Courage'], status: 'active' },
    { content: 'I invest in my own growth daily.', tags: ['Hard work'], status: 'active' },
    { content: 'I attract opportunities for success.', tags: ['Career'], status: 'active' },
    { content: 'I speak my truth with confidence.', tags: ['Courage'], status: 'active' },
    { content: 'I nurture my body with healthy choices.', tags: ['Health'], status: 'active' },
    { content: 'I am surrounded by love and support.', tags: ['Relationships'], status: 'active' },
    { content: 'I let go of comparison and embrace my journey.', tags: ['Growth'], status: 'active' },
    { content: 'I am a powerful creator of my reality.', tags: ['Courage'], status: 'active' },
    { content: 'My energy is contagious and uplifting.', tags: ['Love'], status: 'active' },
    { content: 'I choose to see the good in every situation.', tags: ['Gratitude'], status: 'active' },
    { content: 'I am committed to my personal development.', tags: ['Hard work'], status: 'active' },
    { content: 'I deserve all the good things coming my way.', tags: ['Love'], status: 'active' },
    { content: 'I embrace uncertainty as an opportunity.', tags: ['Courage'], status: 'active' },
    { content: 'I am building a life I love.', tags: ['Career'], status: 'active' },
    { content: 'I treat myself with compassion and care.', tags: ['Health'], status: 'active' },
    { content: 'I am resilient and can overcome any obstacle.', tags: ['Courage'], status: 'active' },
    { content: 'I attract people who value and respect me.', tags: ['Relationships'], status: 'active' },
    { content: 'I am filled with gratitude for my blessings.', tags: ['Gratitude'], status: 'active' },
    { content: 'I take inspired action toward my goals.', tags: ['Hard work'], status: 'active' },
    { content: 'My presence is a gift to those around me.', tags: ['Love'], status: 'active' },
    { content: 'I am in harmony with the universe.', tags: ['Gratitude'], status: 'active' },
    { content: 'I believe in my ability to succeed.', tags: ['Career'], status: 'active' },
    { content: 'I prioritize my mental and physical health.', tags: ['Health'], status: 'active' }
];
