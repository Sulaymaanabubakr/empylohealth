...
exports.sendTemplateEmail = exports.sendBrevoEmail = exports.mailTemplates = void 0;
...
const buildOtpBlock = (code, expiresInMinutes) => {
...
const sendBrevoEmail = async (input) => {
...
const sendTemplateEmail = async (params) => {
    ...
    await (0, exports.sendBrevoEmail)(payload);
};
exports.sendTemplateEmail = sendTemplateEmail;
//# sourceMappingURL=brevoEmail.js.map